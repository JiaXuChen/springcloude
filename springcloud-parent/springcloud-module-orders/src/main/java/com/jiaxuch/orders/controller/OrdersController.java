...
//@DefaultProperties(defaultFallback = "returnNull")
public class OrdersController {
    public final static Logger LOGGER = LoggerFactory.getLogger(OrdersController.class);
    @Autowired
   ...
   public ResultModel getPaymentInfo(@PathVariable("id") String id){
       ...
       for (OrderInfo orderInfo : info) {
           ...
           ResultModel forObject = restTemplate.getForObject("http://springcloud-module-payment/pay/query/" + payId, ResultModel.class);
    ...
    public ResultModel returnNull(){
        return new ResultModel("9999","异常了",new HashMap<>());
    }
